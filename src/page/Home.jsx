...
const content = {
  english: {
    ...
    about: {
      ...
      intro: "Pandit Rajeev Ratan Dwivedi Ji is a highly experienced and knowledgeable Vedic priest with deep expertise in Vedic rituals, pooja procedures, and Jyotish Shastra (Vedic Astrology). He has completed his Master's degree (M.A.) in Sanskrit and is currently serving as the Principal of Narayan Uchattar Madhyamik Vidyalaya.",
      bullets: [
      
        { icon: "ScrollText", text: "Expert in Havan, Vivah, Grih Pravesh, Naamkaran, Mundan & Satyanarayan Katha" },
        { icon: "Telescope", text: "Skilled in Kundli Analysis & Parashari Jyotish — marriage, career, health & more" },
        { icon: "Sparkles", text: "Known as Shri Rajeevanand Ji Maharaj (Haridwar Wale)" },
        { icon: "Globe", text: "Mission: Spreading dharma, positive energy & Vedic traditions across society" },
      ],
    },
    services: {
      title: "Our Services",
  ...
  hindi: {
    ...
    about: {
      ...
      intro: "पंडित राजीव रतन द्विवेदी जी एक विद्वान एवं अनुभवी वैदिक पंडित हैं, जिन्हें वेद, शास्त्र, पूजन-विधि तथा ज्योतिष शास्त्र का गहन ज्ञान है। उन्होंने संस्कृत विषय में एम.ए. की उपाधि प्राप्त की है और वर्तमान में नारायण उच्चत्तर माध्यमिक विद्यालय में प्रधानाचार्य के पद पर कार्यरत हैं।",
      bullets: [
      
        { icon: "ScrollText", text: "हवन, विवाह, गृह प्रवेश, नामकरण, मुंडन एवं सत्यनारायण कथा में विशेषज्ञ" },
        { icon: "Telescope", text: "कुंडली विश्लेषण एवं पाराशरी ज्योतिष — विवाह, करियर, स्वास्थ्य आदि समाधान" },
        { icon: "Sparkles", text: "श्री राजीवानंद जी महाराज (हरिद्वार वाले) के नाम से प्रसिद्ध" },
        { icon: "Globe", text: "उद्देश्य: समाज में धर्म, संस्कार और सकारात्मक ऊर्जा का प्रसार" },
      ],
    },
    services: {
      title: "हमारी सेवाएं",
  ...
  sanskrit: {
    ...
    about: {
      ...
      intro: "पण्डितः राजीव रतन द्विवेदी जी विद्वान् अनुभवी च वैदिक-पुरोहितः सन्ति। तेषां वेदेषु, शास्त्रेषु, पूजन-विधौ तथा ज्योतिष-शास्त्रे गाढं ज्ञानम् अस्ति। ते संस्कृत-विषये एम.ए. उपाधिं प्राप्तवन्तः सन्ति तथा नारायण उच्चत्तर माध्यमिक विद्यालये प्रधानाचार्य-पदे कार्यरताः सन्ति।",
      bullets: [
        { icon: "ScrollText", text: "हवन-विवाह-गृहप्रवेश-नामकरण-मुण्डन-सत्यनारायणकथासु विशेषज्ञः" },
        { icon: "Telescope", text: "कुण्डलीविश्लेषणे पाराशरीज्योतिषे च दक्षः — विविधसमस्यानां समाधानम्" },
        { icon: "Sparkles", text: "श्री राजीवानन्द जी महाराज (हरिद्वार) इति नाम्ना प्रसिद्धः" },
        { icon: "Globe", text: "लक्ष्यम्: धर्मस्य संस्कारस्य सद्भावनायाश्च प्रचारः" },
      ],
    },
    services: {
      title: "अस्माकं सेवाः",
        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-4 py-3 sm:py-4 flex items-center justify-between gap-2 flex-wrap">
          <div className="flex items-center gap-2 flex-shrink-0">
            ...
            <div className="hidden sm:block">
              <p className="text-base sm:text-lg font-bold text-orange-900 leading-tight">Rajeev Ratan Dwivedi</p>
    ...
    <div className="max-w-2xl">
          ...
          <div className="flex flex-col md:flex-row items-start gap-8 md:gap-10">
            ...
            <div className="flex-1 text-center md:text-left">
              <p className="font-bold text-orange-800 text-xl sm:text-2xl md:text-3xl block mb-3">
                Pandit Rajeev Ratan Dwivedi Ji
              </p>
              {/* Intro paragraph */}
      ...
      <footer className="bg-orange-950 text-orange-200 py-8 sm:py-10">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 text-center">
          ...
          <h3 className="text-lg sm:text-xl font-bold text-amber-300 mb-1">Rajeev Ratan Dwivedi</h3>
          ...
          <div className="border-t border-orange-800 pt-4 sm:pt-5 text-xs text-orange-500">
            © {new Date().getFullYear()} Pandit Rajeev Ratan Dwivedi. All Rights Reserved. | 📍 Ghaziabad , UP, India
          </div>
        </div>
      </footer>
    </div>
